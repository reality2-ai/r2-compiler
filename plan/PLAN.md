...
**F-series — substrate buildout (L0–L5).** The device-scoped, always-running, TG-agnostic core of the hive ([[reference-r2-substrate]]), authored in `orchestrator/src/substrate/`. Tracks the stack-view (S-series) work in the webapp.
