...
TCP OTA receiver (port 21043). COMPULSORY per SPEC-R2-COMPILER §12.1 — without it the device is unmanageable after first install.
...
1. plugin.toml · 2. PLUGIN.md · 3. SPEC-R2-COMPILER §12.1 · 4. R2-DEPLOY §4.7 (upstream) · 5. reference sender.rs
