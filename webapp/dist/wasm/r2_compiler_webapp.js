/* @ts-self-types="./r2_compiler_webapp.d.ts" */
 ...
 * @returns {string}
 */
export function class_hash_hex(s) {
    let deferred2_0;
    let deferred2_1;
    try {
        ...
        wasm.class_hash_hex(retptr, ptr0, len0);
 ...
 * @returns {boolean}
 */
export function verify_class_hash(s, expected_hex) {
    const ptr0 = passStringToWasm0(s, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(expected_hex, wasm.__wbindgen_export2, wasm.__wbindgen_export3);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.verify_class_hash(ptr0, len0, ptr1, len1);
    return ret !== 0;
}
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./r2_compiler_webapp_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('r2_compiler_webapp_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
